  ...
  <div>
    ...
    <div class="container">
      <div class="card border-danger">
        <small class="mt-2">Question 1</small>
        <h2>"JavaScript pertama kali dikembangkan oleh Brendan Eich dari Netscape di bawah nama Java?"</h2>
      </div>
    </div>
    <div class="container mt-3">
      <button @click="salah" class="btn fontbtn btn-success ml-4"><h1>Benar</h1></button> |
      <button class="btn btn-danger fontbtn mr-4"><h1>Salah</h1></button>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    salah () {
      Swal.fire({
        icon: 'error',
        title: 'Oops... Jawaban Salah!',
        text: 'yang benar nama awalnya Mocha',
      })
    }
  }
}
